...
import { AppBar, Toolbar, Typography, Button, Box, IconButton, Menu, MenuItem, useMediaQuery, useTheme, Stack, Badge } from '@mui/material';
        ...
        {isMobile ? (
          <>
            ...
            >
              ...
              <MenuItem onClick={handleClose} component={Link} to="/contacto">Contacto</MenuItem>
              <MenuItem onClick={handleClose} component={Link} to="/carrito">
                Carrito ({cart.length})
              </MenuItem>
              {user ? (
                [
                  <MenuItem key="profile" onClick={handleClose} component={Link} to="/perfil">
                    Perfil
                  </MenuItem>,
                ...
                [
                  ...
                  <MenuItem key="register" onClick={handleClose} component={Link} to="/registro">
                    Registrarse
                  </MenuItem>,
                ]
              )}
          ...
          <Stack direction="row" spacing={1} alignItems="center" sx={{ flex: 1, justifyContent: 'center' }}>
            ...
            <Button color="inherit" component={Link} to="/productos" sx={{ fontWeight: 500 }}>Productos</Button>
            <Box>
              <Button
                color="inherit"
            ...
            <Button color="inherit" component={Link} to="/contacto" sx={{ fontWeight: 500 }}>Contacto</Button>
          </Stack>
        )}

        <Stack direction="row" spacing={1} alignItems="center">
          <IconButton color="inherit" component={Link} to="/carrito" size="large">
